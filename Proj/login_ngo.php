...
<body>
    ...
    <div class="container">
        ...
        <div class="form-section">
            <FORM action = "connect_login_ngo.php" name="login" method="POST">
                <!-- login form -->
                <div class="login-box">
                    <input type="email" 
                        name="email"
            ...
            <FORM action = "connect_signup_ngo.php" name="signup" method="POST">
                <!-- signup form -->
                <div class="signup-box">
					...
					<input type="text"
                        name="org" 
                        class="id ele" 
                        placeholder="Organization Name (Least 5 Characters)"
						maxlength = "35"
						minlength = "5"
						autocomplete="off"
						required>
                    ...
                    <input type="password" 
						...
						autocomplete="off"
						required>
                    <button name="button" class="clkbtn">Sign up</button>
                </div>
            </FORM>
        </div>
    </div>
    <script src="login_ngo.js"></script>
</body>
